...
Tags: customizer, theme customizer, framework, wrapper, option, options, setting, settings, theme_mod, theme_mods, sanitization
...
Install like any other plugin. If you're a theme developer, then you already know how to install a plugin, and I won't bore you with the details. See [Other Notes](http://wordpress.org/plugins/customizer-framework/other_notes/) for usage instuctions.
